...
public class FileComponent {
	...
	private Map<String, Object> resultMap;
	  ...
	  private String getName(MultipartFile file) {return file.getOriginalFilename();} //nm1
	  private String setName() {return Long.toString(System.nanoTime());} //nm2
	  private String getExtension(MultipartFile file) { //extension
	    String contentType = file.getContentType(); //tyep
